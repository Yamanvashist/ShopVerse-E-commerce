...
const useAuthStore = create((set) => ({
    ...
    register: async ({username,email,password}) => {
        ...
        try {
            ...
            set({ error: error.response?.data?.message || "Signup failed, bro", loading: false });
        }
    },
    ...
    login: async (credentials) => {
        ...
        try {
            ...
            set({ error: error.response?.data?.message || "Login failed, check your inputs", loading: false });
        }
    },
